...
export const DEFAULTS = {
  ...
  sobre_text1: 'Sou Hallison Matheus, advogado com atuação em Goiânia e Goiás. Meu trabalho vai muito além de processos: atuo ajudando pessoas e empresas a resolverem problemas com estratégia, segurança jurídica e inteligência — sempre buscando a melhor solução para cada situação.',
