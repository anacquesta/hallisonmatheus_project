...
export default function Hero({ config = {} }) {
  ...
  const subtitle = config.hero_subtitle || 'Atuação personalizada e estratégica com foco em resultados reais e segurança jurídica para pessoas e empresas em Goiânia e Goiás.';
